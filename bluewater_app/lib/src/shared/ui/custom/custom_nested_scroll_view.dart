...
// ignore_for_file: lines_longer_than_80_chars, unnecessary_null_comparison, omit_local_variable_types, curly_braces_in_flow_control_structures, avoid_types_on_closure_parameters, avoid_positional_boolean_parameters, avoid_private_typedef_functions
...
class _NestedScrollPosition extends ScrollPosition
  ...
  void restoreScrollOffset() {
    ...
    final CustomNestedScrollViewState? ancestorStateIsNestedScrollViewState =
        elementWithPageStorageKey
            ?.findAncestorStateOfType<CustomNestedScrollViewState>();
    if (identical(ancestorStateIsNestedScrollViewState, coordinator._state) ||
        coordinator.canScrollBody) super.restoreScrollOffset();
  }
